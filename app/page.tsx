...
import { Check, Menu, Moon, Sun, X, Activity } from "lucide-react";
  ...
  const portfolioItems = [
    {
      ...
      imageUrl: "/icon.svg?height=400&width=600",
      link: "#",
    },
    {
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-sans antialiased transition-colors duration-200">
      ...
      <footer className="bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-sm text-center">© {new Date().getFullYear()} Gracensity. All Rights Reserved.</p>
        </div>
      </footer>
    </div>
  );
